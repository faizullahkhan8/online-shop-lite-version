...
const AboutUs = () => {
    ...
    return (
        <div className="min-h-screen bg-[#fdfdfb]">
            ...
            <div className="relative w-full bg-[#f4f8f2] border-b border-[#e8f0e4] overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-6 lg:px-12 py-14 md:py-16 flex flex-col items-center text-center">
                    ...
                    <motion.div
                        ...
                        className="w-10 h-[1px] bg-[#b5d4a6] origin-center"
                    />
                </div>
            </div>

            {/* ── Story Text ── */}
            <section ref={heroRef} className="max-w-7xl mx-auto px-6 lg:px-12 py-14">
                <Breadcrumb items={breadcrumbItems} />
                <motion.div
                ...
                >
                    <p className="text-stone-600 text-sm leading-loose tracking-wide">
                        At <span className="font-semibold text-[#1a2e1a]">Askar.pk</span>, we believe that good health should be simple, natural, and trustworthy.
                        We offer 100% natural and organic healthcare products designed to support healthy weight gain and effective weight management. Our approach is honest and balanced focusing on safe formulations made with pure, organic ingredients that work in harmony with your body.
                        Every product at <span className="font-semibold text-[#1a2e1a]">Askar.pk</span> is created with care, quality, and your well-being in mind. No harsh chemicals, no false claims just natural support for a healthier and more confident you.
                        <span className="font-semibold text-[#1a2e1a]"> Askar.pk</span> natural care for a balanced, healthier life.
                    </p>
                </motion.div>
            </section>

            {/* ── Founder Section ── */}
            <section ref={founderRef} className="py-16 bg-[#f4f8f2] border-y border-[#e8f0e4]">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            <div className="absolute top-5 left-5 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-xl border border-[#e8f0e4]">
                                <span className="text-[10px] uppercase tracking-[0.25em] text-[#1a2e1a] font-medium">Founder</span>
                            </div>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="lg:pl-8"
                        >
                            <span className="text-[10px] uppercase tracking-[0.4em] text-[#7aaf68] mb-3 block">Meet the Visionary</span>
                            <h2 className="text-2xl font-light uppercase tracking-[0.2em] text-[#1a2e1a] mb-5">
                                Faiz Ullah Khan
                            </h2>
                            <div className="w-8 h-[1px] bg-[#b5d4a6] mb-6" />
                            ...
                            <div className="space-y-5">
                                {contactItems.map((item, i) => (
                                    ...
                                    >
                                        ...
                                        <div>
                                            <p className="text-[10px] uppercase tracking-[0.3em] text-stone-400 mb-0.5">{item.label}</p>
                                            <p className="text-sm font-medium tracking-wider text-[#1a2e1a]">{item.value}</p>
                                        </div>
                                    </motion.div>
                                ))}
                            </div>
            ...
            <section ref={ctaRef} className="py-24 border-b border-[#e8f0e4]">
                <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.55, ease: "easeOut", delay: 0.2 }}
                        className="w-10 h-[1px] bg-[#b5d4a6] mx-auto mb-8 origin-center"
                    />
                    <motion.div
            ...
            {/* ── Contact Form ── */}
            <section ref={contactRef} className="py-16 bg-[#f4f8f2] border-b border-[#e8f0e4]">
                <div className="max-w-7xl mx-auto px-6 lg:px-12">
                    <div className="grid lg:grid-cols-12 gap-12">
                        ...
                        >
                            <span className="text-[10px] uppercase tracking-[0.4em] text-[#7aaf68] mb-3 block">Reach Out</span>
                            <h2 className="text-2xl font-light uppercase tracking-[0.2em] text-[#1a2e1a] mb-4">
                                Contact Us
                            </h2>
                            <div className="w-8 h-[1px] bg-[#b5d4a6] mb-5" />
                            <p className="text-xs text-stone-400 leading-loose tracking-wide">
                                Have a question about our products or your order? We're here to help. Drop us a message and we'll get back to you.
                            </p>
                        </motion.div>

                        {/* Form */}
                        <motion.div
                            custom={0.12} variants={fadeUp} initial="hidden"
                            animate={contactInView ? "visible" : "hidden"}
                        ...
                        >
                            ...
                            <form onSubmit={handleSendEmail} className="space-y-10">
                                <div className="relative border-b border-[#dcebd5] pb-2 focus-within:border-[#7aaf68] transition-colors">
                                    <label className="text-[10px] uppercase tracking-[0.3em] text-stone-400 block mb-2">Name</label>
                                    <input
                                        type="text"
                                        required
                                        value={formData.name}
                                ...
                                <div className="relative border-b border-[#dcebd5] pb-2 focus-within:border-[#7aaf68] transition-colors">
                                    <label className="text-[10px] uppercase tracking-[0.3em] text-stone-400 block mb-2">Message</label>
                                    <textarea
                                        required
                                        rows={4}
                                        value={formData.message}
