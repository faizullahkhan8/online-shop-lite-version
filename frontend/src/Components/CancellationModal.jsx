                ...
                <div className="px-5 py-4 space-y-3">
                    <div className="space-y-1.5">
                        ...
                        <textarea
                            ...
                            className="w-full h-24 px-3 py-2.5 text-sm font-semibold border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-500 resize-none"
                        />
                        {error && (
