...
const PromotionSection = () => {
    ...
    return (
        ...
        //             <p className="text-sm uppercase tracking-[0.35em] text-gray-400 font-sans">
        //                 Promotions
        //             </p>
        //             <h2 className="text-sm font-semibold font-medium tracking-[0.3em] uppercase text-gray-900 font-sans">
        ...
        //                 </div>
        //                 <div>
        //                     <p className="text-sm font-semibold font-semibold text-red-700">
        ...
        //         {isLoading && (
        //             <div className="flex items-center justify-center text-gray-500 text-sm font-semibold gap-2">
            ...
            <div className="max-w-7xl mx-auto space-y-6 sm:space-y-8">
                ...
                {isLoading ? (
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5">
                        <div className="h-64 sm:h-90 rounded-2xl border border-gray-200 bg-gray-50 animate-pulse" />
                        <div className="h-64 sm:h-90 rounded-2xl border border-gray-200 bg-gray-50 animate-pulse" />
                    </div>
                ) : isError ? (
                    <div className="rounded-2xl border border-red-200 bg-red-50 p-4 sm:p-5 flex items-start gap-3">
                        <div className="w-9 h-9 rounded-xl bg-red-100 text-red-600 flex items-center justify-center shrink-0">
                            <Megaphone size={16} />
                        </div>
                        <div>
